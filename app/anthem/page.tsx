        ...
        <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg text-primary-foreground/90 max-w-2xl mx-auto">
              The anthem of Midland High School - Luweero embodies our values, aspirations, and
              commitment to excellence in education and character development.
            </p>
          </div>
        </section>
            ...
            <Card className="mb-12">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-bold text-primary">
                  Midland High School - Luweero Anthem
                </CardTitle>
                <CardDescription>
              ...
              <CardContent className="text-center">
                <div className="space-y-6 text-lg leading-relaxed">
                  <div className="bg-muted/30 p-6 rounded-lg">
                    ...
                    <p className="italic">
                      Midland High, our alma mater dear,
                      <br />
                      Standing tall with values clear.
                      <br />
                      Building brains with character strong,
                      <br />
                  ...
                  <div className="bg-muted/30 p-6 rounded-lg">
                    ...
                    <p className="italic font-bold text-primary">
                      Oh Midland High, we sing your praise,
                      <br />
                  ...
                  <div className="bg-muted/30 p-6 rounded-lg">
                    ...
                    <p className="italic">
                      Teachers guide with wisdom's light,
                      <br />
                      Students shine with knowledge bright.
                      <br />
                      Unity and friendship strong,
                      <br />
                      Together we belong.
                    </p>
                  </div>
                  ...
                  <div className="bg-muted/30 p-6 rounded-lg">
                    ...
                    <p className="italic">
                      From Luweero to nations far,
                      <br />
                      Midland's shining like a star.
                      <br />
                      Service, leadership, and grace,
                      <br />
                ...
                <CardContent className="space-y-3">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Academic excellence combined with moral development
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Preparing students to serve their communities
                      </p>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Graduation ceremonies and prize-giving events
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
              ...
              <CardContent>
                <div className="prose prose-sm max-w-none">
                  <p className="text-muted-foreground leading-relaxed">
                    The Midland High School anthem is more than just a song – it's a declaration of
                    our commitment to excellence, unity, and service. Every student and staff member
                    is encouraged to learn the anthem and sing it with pride, as it represents the
                    shared values and dreams that unite our school community.
                  </p>
                  <div className="mt-6 p-4 bg-primary/10 rounded-lg border border-primary/20">
                    <p className="font-semibold text-primary mb-2">Remember:</p>
                    <p className="text-sm text-muted-foreground">
                      "Building Brains With Character" is not just our motto – it's the foundation
                      upon which Midland High School stands, and the principle that guides
                      everything we do.
                    </p>
                  </div>
                </div>
